    ...
    <div className="md:flex md:flex-wrap md:mx-8">
      {filteredProjects.map((project) => (
        <div key={project.id} className="flex flex-col lg:w-[50%] md:px-6 my-6">
          <div
            className="h-[29.5rem] md:h-[37rem] px-6 border-2 border-[rgba(75,30,133,0.5)] rounded-3xl bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)] 
          ...
          >
            ...
            <div className="grid grid-cols-2 md:flex md:flex-row gap-2 md:gap-6 pr-3 md:pr-0 my-4">
              {project.links.map((link, index) => (
                <button
                  key={index}
                  className="flex items-center justify-center gap-2 border-2 py-1 px-3 rounded-2xl transition-all duration-300 hover:bg-white hover:text-black"
                >
            ...
            <div className="flex items-center gap-x-3 md:gap-x-4 mt-3">
              <p className="text-bold text-left ">Skill Used:</p>
